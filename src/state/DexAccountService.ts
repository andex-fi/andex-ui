...
import { DexAccountUtils, DexUtils, getFullContractState } from '../constants'
...
export class DexAccountService extends BaseStore<DexAccountData, DexAccountState> {
    ...
    public async init(): Promise<void> {
        ...
        try {
            const state = await getFullContractState(this.dexRootAddress, venomProvider)
    ...
    protected async handleAccountChange(address?: Address): Promise<void> {
        ...
        try {
            const state = await getFullContractState(address, venomProvider)
