...
import { dexAccountContract, dexPairCallbacksContract, getFullContractState } from '../contracts'
...
} from '../utils/StablePoolUtils'
import { TokenWalletUtils } from '../utils/TokenWalletUtils'
import type {
    ...
    public static async depositLiquidity(
        ...
        try {
            ...
            const message = await DexAccountUtils.depositLiquidityV2(params.dexAccountAddress, {
                callId,
                expected: { amount: expectedAmount, root: resolveVenomAddress(params.expected.root) },
