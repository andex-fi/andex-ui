export abstract class FarmAbi {
  static Fabric = {
    ...
    functions: [
      ...
      {
        name: "processUpgradeFarmPoolRequest",
      ...
      },
      {
        ...
        inputs: [],
        outputs: [{ name: "masterchef_version", type: "uint32" }],
      },
      {
        name: "farm_pool_version",
        inputs: [],
        outputs: [{ name: "farm_pool_version", type: "uint32" }],
      },
      {
        name: "user_data_version",
        inputs: [],
        outputs: [{ name: "user_data_version", type: "uint32" }],
      },
      {
        name: "pools_count",
        inputs: [],
        outputs: [{ name: "pools_count", type: "uint64" }],
      },
      {
        name: "owner",
        inputs: [],
      ...
      },
      {
        ...
        inputs: [],
        outputs: [{ name: "FarmPoolUserDataCode", type: "cell" }],
      },
      {
        name: "FarmPoolCode",
        inputs: [],
        outputs: [{ name: "FarmPoolCode", type: "cell" }],
      },
      {
        name: "PlatformCode",
        inputs: [],
        outputs: [{ name: "PlatformCode", type: "cell" }],
      },
      {
        name: "nonce",
        inputs: [],
  ...
  static Pool = {
    ...
    functions: [
      ...
      {
        name: "dummy",
        inputs: [{ name: "user_wallet", type: "address" }],
        outputs: [],
      },
      {
      ...
      },
      {
        ...
        outputs: [{ name: "deposit_payload", type: "cell" }],
      },
      {
