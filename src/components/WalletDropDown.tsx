      ...
      <Menu as="div" className="relative text-left w-auto inline-block">
        {({ open }) => (
          <>
            ...
            <Menu.Items className="absolute p-6 right-0 mt-6 w-[380px] origin-top-right divide-y divide-gray-100 rounded-xl bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
