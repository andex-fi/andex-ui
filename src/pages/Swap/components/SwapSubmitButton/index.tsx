...
function SubmitButton(): JSX.Element {
    ...
    const symbol = (formStore.coinSide === 'leftToken' ? formStore.wallet.coin.symbol : formStore.leftToken?.symbol) || '';
    ...
    switch (true) {
        ...
        case !formStore.isLeftAmountValid:
            buttonProps.disabled = true
            buttonText = formStore.isComboSwapMode ? 'Insufficient balance' : `Insufficient <s>${symbol}</s> balance`
            break
