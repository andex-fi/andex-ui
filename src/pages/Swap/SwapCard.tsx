...
const SwapCard: FC  = () => {
  ...
  return (
    <div className="flex justify-center items-center h-full m-auto p-20 drop-shadow-2xl ">
      <div className="w-[24rem] text-blck dark:text-white md:w-[32rem]">
        ...
        <div className="flex flex-row justify-center"><ArrowsUpDownIcon className="w-[2rem] z-10 -m-4 p-1 bg-white drop-shadow-xl text-[#3a93ed] dark:text-white text-blue dark:bg-purple-light rounded rounded-full" /> </div>
