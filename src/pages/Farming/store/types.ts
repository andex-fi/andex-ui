import { Address, FullContractState, TransactionId } from "@andex/provider";

import { UserPendingReward } from "./farm";
...
export type EventType = "deposit" | "withdraw" | "claim" | "rewarddeposit";
